...
// a 프레임을 양쪽 디스플레이에 표현하기
   alpha_coding1a();    delay(delayTime);
//    alpha_coding2a(); delay(delayTime);
// b frame
    alpha_coding1b();    delay(delayTime);
// c frame
    alpha_coding1c();    delay(delayTime);
 // d frame
    alpha_coding1d();    delay(delayTime);
// e frame
    alpha_coding1e();    delay(delayTime);
// f frame
    alpha_coding1f();    delay(delayTime);
// g frame
    alpha_coding1g();    delay(delayTime);
// h frame
    alpha_coding1h();    delay(delayTime);   
// i frame
    alpha_coding1i();    delay(delayTime);
// j frame
    alpha_coding1j();    delay(delayTime);  
}
