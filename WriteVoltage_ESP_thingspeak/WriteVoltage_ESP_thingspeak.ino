...
//#define USE_ETHERNET_SHIELD
    ...
    // Use WiFi
      ...
      #include <WiFi101.h>
    #endif
    char ssid[] = "U+Net3C70";    //  your network SSID (name) 
    char pass[] = "5000012132";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 283026;
const char * myWriteAPIKey = "NR13EA31SOHLKDGE";
...
void loop() {
  ...
  ThingSpeak.writeField(myChannelNumber, 1, "3.2", myWriteAPIKey);
