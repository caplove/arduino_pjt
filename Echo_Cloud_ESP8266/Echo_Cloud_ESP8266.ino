...
// Include the SparkFun Phant library. 라이브러리 추가에서 SparkFun Phant 로 검색
#include <Phant.h>

//Set your network name and password
const char WiFiSSID[] = "U+Net3C70"; //your wifi network name goes here
const char WiFiPSK[] = "5000012132"; //your wifi password goes here
...
const char parseKey[] = "led"; //This is used to parse through data from Phant to find light setting

//declare phant address and security keys
const char PhantHost[] = "data.sparkfun.com";
const char gPublicKey[] = "1K07Y5mnKoFEAgWgYJ3y"; //your phant public key goes here
const char gPrivateKey[] = "02k6X1zm2wuNp757emJG"; //your phant private key goes here
