...
// MD_MAX72xx-master를 라이브러리폴더에 복사
#define RUN_DEMO  1
...
#define CLK_PIN  26  // or SCK
#define DATA_PIN 22  // or MOSI
#define CS_PIN  24  // or SS
...
{
    	"Hello, alpha coding group members!!!",
		"Let's make world smart",
		"ONE MORE TIME",
		"HARDER  BETTER  FASTER  STRONGER",
		"HUMAN AND ROBOT",
		"TECHNOLOGIC",
